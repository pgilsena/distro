...
libdir     = "/home/pippa/Documents/Senior Sophister/CS 4032 - Distributed Systems/Labs & Tutorials/distro/dfs/securityServer/.stack-work/install/x86_64-linux/lts-7.12/8.0.1/lib/x86_64-linux-ghc-8.0.1/securityServer-0.1.0.0-4imf3VzpPgz54RyWy2drrk"
...
getBinDir = catchIO (getEnv "securityServer_bindir") (\_ -> return bindir)
getLibDir = catchIO (getEnv "securityServer_libdir") (\_ -> return libdir)
getDataDir = catchIO (getEnv "securityServer_datadir") (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "securityServer_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "securityServer_sysconfdir") (\_ -> return sysconfdir)
