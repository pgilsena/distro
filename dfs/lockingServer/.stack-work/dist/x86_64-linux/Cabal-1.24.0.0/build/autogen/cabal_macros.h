...
/* package lockingServer-0.1.0.0 */
#define VERSION_lockingServer "0.1.0.0"
#define MIN_VERSION_lockingServer(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "lockingServer-0.1.0.0-DIrpllyqKCmCgphmrr1CT4"

#define CURRENT_PACKAGE_KEY "lockingServer-0.1.0.0-DIrpllyqKCmCgphmrr1CT4"
