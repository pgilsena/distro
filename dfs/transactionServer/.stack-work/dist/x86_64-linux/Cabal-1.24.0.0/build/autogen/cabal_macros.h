...
/* package transactionServer-0.1.0.0 */
#define VERSION_transactionServer "0.1.0.0"
#define MIN_VERSION_transactionServer(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "transactionServer-0.1.0.0-50FNYovDyX86t2sBeK4Aso"

#define CURRENT_PACKAGE_KEY "transactionServer-0.1.0.0-50FNYovDyX86t2sBeK4Aso"
